...
```mermaid
graph LR
    A[1. Codebase-Research-Explorer<br/>locate-only, 1 agent] --> B[2. Diagnose<br/>read error,<br/>find root cause]
...
```mermaid
graph TD
    A["Codebase-Research-Explorer: hi-codebase-research-explorer<br/>2-3 parallel"] --> B["Diagnose"]
