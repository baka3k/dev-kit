...
Each return is refinement, not restart.

## Hypothesis-Driven & Multi-Branch Convergence
...
| **Multi-Branch Convergence** | Complex decisions where neither option clearly best | explorer Branch A benefits/drawbacks + Branch B benefits/drawbacks → `[CONVERGENCE]` hybrid combining best of each |
