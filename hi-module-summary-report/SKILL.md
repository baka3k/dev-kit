...
Read [shared/leaf-contract.md](../shared/leaf-contract.md). Consume evidence; do not independently rediscover the repository. Lifecycle orchestrator owns refinement, review, approval, and publication.
