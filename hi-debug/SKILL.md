...
- **Codebase:** `ck:docs-seeker` (package docs), `ck:repomix` (summary), `/ck:ciu` (scout files)
- **Frontend/Problem-solving:** Chrome browser or `ck:chrome-devtools` for visual verification; `ck:problem-solving` when stuck
