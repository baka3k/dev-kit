...
For codebase: read `docs/codebase-summary.md` if exists and <2 days old, otherwise use `ck:repomix`; use `/ck:ciu` to find relevant files; use `ck:docs-seeker` for package docs.
