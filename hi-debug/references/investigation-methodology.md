...
For codebase: read `docs/codebase-summary.md` if exists and <2 days old, otherwise use `hi-repository-search`; use `/hi-codebase-research-explorer` to find relevant files; use `hi-docs-seeker` for package docs.
