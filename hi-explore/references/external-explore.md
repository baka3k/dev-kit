...
If the target is **within the local codebase** → use `internal-explorer.md` (Glob/Grep).
...
* If all agents fail → mark explorer result as "incomplete", and recommend internal mode or manual research.
