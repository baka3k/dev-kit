...
# explorer (Parallel Codebase + External Researcher)
...
- **Internal mode**: load `references/internal-explorer.md` — dùng Glob/Grep
- **External mode**: load `references/external-explorer.md` + `references/external-research.md` — dùng MCP tools
