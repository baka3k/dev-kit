...
Read [shared/orchestrator-contract.md](../shared/orchestrator-contract.md). Own the wiki run directory, page generation, knowledge card assembly, wiki_plan configuration, and incremental update logic.
...
Read [shared/retrieval-protocol.md](../shared/retrieval-protocol.md) for evidence gathering.
