...
Spawn log-writer subagent to explore memories and recent code changes, write concise log entries to ./docs/logs/.
...
Use hi:explore if scope is ambiguous. Honor `--since` / `--scope` filters.
