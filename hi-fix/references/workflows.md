...
1. Codebase-Research-Explorer: locate file + direct deps only
...
1. Codebase-Research-Explorer: hi-codebase-research-explorer or 2-3 parallel explorer
...
1. Parallel: Codebase-Research-Explorer + Diagnose + Research
2. Fix: root cause
