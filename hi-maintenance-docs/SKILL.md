...
Read [shared/orchestrator-contract.md](../shared/orchestrator-contract.md). Own the run directory, global manifest, joins, contradiction handling, index, freshness, and final status. Leaves own only their isolated outputs.
